...
---------------------- INPUT FILES ---------------------------------------------
"ED1_WT1_yaw_0000_modwake2.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"SD1_WT1_yaw_0000_modwake2.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
