...
OpenFAST2     model         - for NM80 used in IEA task#29
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"NM80_ED2.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"../NM80-OF3.0/NM80_IW.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"../NM80-OF3.0/NM80_AD15.06.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"../NM80-OF3.0/NM80_SD.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
...
0.001         TrimTol - Tolerance for the rotational speed convergence [>eps] [used only when CalcSteady=True]
1.0           TrimGain - Proportional gain for the rotational speed error (rad/(rad/s) or Nm/(rad/s)) [>0] [used only when CalcSteady=True]
1.0           Twr_Kdmp - Damping factor for the tower (N/(m/s)) [>=0] [used only when CalcSteady=True]
1.0           Bld_Kdmp - Damping factor for the blade (N/(m/s)) [>=0] [used only when CalcSteady=True]
1             NLinTimes     - Number of times to linearize (-) [>=1] [unused if Linearize=False]
10            LinTimes      - List of times at which to linearize (s) [1 to NLinTimes] [unused if Linearize=False]
