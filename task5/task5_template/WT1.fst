...
---------------------- INPUT FILES ---------------------------------------------
"ED1.dat"   EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"SD1.dat"      ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
